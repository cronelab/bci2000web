...
let dx = 10;
let dy = 0;
const modifyValsX = (x: number) => (dx = x);
const modifyValsY = (y: number) => (dy = y);
...
const Snake = () => {
  ...
  const bciSource = useStore.getState().bciSource
