...
Load parameterfile "../parms.ecog/UPMC/WordClass/wordclass.prm"

EXECUTE SCRIPT "../batch.ecog/setup_storage.txt" UPMC_WordClass

Echo Which Block (1, 2, 3, 4, 5)?
Set seq ${Read Line}
ECHO Loading Block $seq 
Load parameterfile "../parms.ecog/UPMC/WordClass/block$seq.prm"
