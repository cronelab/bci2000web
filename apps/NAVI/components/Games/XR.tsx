...
import { Camera, Clock, LineSegments, Raycaster, Scene, WebGLRenderer, Matrix4, BufferGeometry,Float32BufferAttribute, MathUtils, Mesh, RingGeometry, MeshBasicMaterial,
AdditiveBlending, LineBasicMaterial, sRGBEncoding, Line, HemisphereLight, PerspectiveCamera, Color,DirectionalLight, MeshLambertMaterial, BoxGeometry,
Vector3,
Object3D,
Group,
XRInputSource
...
const XR = () => {
  ...
  let room: LineSegments;

  let controller: Group;
  let controllerGrip;
  let INTERSECTED: Mesh;
